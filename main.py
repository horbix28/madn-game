...
class MenschAergereDichNicht:
    ...
    def game_loop(self):
        ...
        while not self.game_over:
            ...
            movable_figures, immovable_figures = self.calc_dice_roll_effect(player, roll)
            if movable_figures:
                print("Movable figures now: ", " ".join([f"Figure {i} -> {movable_figures[i]} | " for i in movable_figures]), "\n which one do u like to move?")
                move_fig = None
